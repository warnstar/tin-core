...
class Request extends Message implements ServerRequestInterface
{
    ...
    public static function createFromSwoole(\Swoole\Http\Request $swooleRequest, \Swoole\Http\Response $swooleResponse)
    {
        ...
        $request->swRequest = $swooleRequest;
        $request->response = new Response($swooleResponse);
        return $request;
    }
     ...
     */
    public function endShow(string $content)
    {
